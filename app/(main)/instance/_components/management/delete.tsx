  ...
  return (
    <div className="space-y-4">
      ...
      <div className="space-y-4">
        ...
        {isRunning ? (
          <Alert>
            ...
            <AlertDescription>
              Running instances must be stopped before deletion. You can force a stop first and then
              continue with deletion from here.
            </AlertDescription>
          </Alert>
        ) : null}
        ...
        {isDeleteProtected ? (
          <Alert>
            ...
            <AlertDescription>
              Disable <code>security.protection.delete</code> before deleting this instance.
            </AlertDescription>
          </Alert>
        ) : null}
        ...
        {!isRunning && !isDeleteProtected ? (
          <p className="text-muted-foreground text-sm">
            The delete request will be sent immediately and progress will be tracked through the
      ...
      <ManagementFooter
        ...
        primaryLabel={canForceDelete && forceDelete ? 'Force stop and delete' : 'Delete instance'}
