    ...
    <DialogPortal data-slot="dialog-portal">
      ...
      <DialogPrimitive.Content
        ...
        onPointerDownOutside={(event) => {
          ...
          // Resize gestures from react-resizable-panels call preventDefault() on the original
          // pointerdown. Preserve normal outside-click dismissal, but don't close the dialog
          // when that prevented event is actually starting a pane resize.
